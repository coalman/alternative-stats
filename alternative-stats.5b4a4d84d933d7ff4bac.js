...
var _quiz = __webpack_require__(350);

var _quiz2 = _interopRequireDefault(_quiz);

var _quizQuestion = __webpack_require__(355);

var _quizQuestion2 = _interopRequireDefault(_quizQuestion);

var _quizResult = __webpack_require__(360);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4768946f_hasScoped_false_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_home_vue__ = __webpack_require__(349);
var disposed = false
...
module.exports = {"name":"Karl Pearson or Pierre the D'Anjou Pear","publishdate":"2018-09-06T00:00:00.000Z","icons":[{"src":"karl-pearson.svg","alt":"Karl Pearson"},{"src":"danjou-pear.svg","alt":"Pierre the D'Anjou Pear"}],"questions":[{"question":"Studied mathematics in King's College at the University of Cambridge","choices":[{"image":"karl-pearson.svg","alt":"Karl Pearson","response":"Pearson graduated at the level of Third Wrangler, the designation used at King's College for the third highest scoring undergraduate student in mathematics.","correct":true},{"image":"danjou-pear.svg","alt":"Pierre the D'Anjou Pear","response":"Pierre took a year off during college to 'find himself,' during which time he was inspired to join a movement to ban the use of the adjective 'pear-shaped' to describe a person with a big butt.","correct":false}]},{"question":"Credited with establishing the discipline of mathematical statistics","choices":[{"image":"karl-pearson.svg","alt":"Karl Pearson","response":"Besides his work in statistics, Pearson had expertise and influence in a number of fields including mathematics, law, history, and biometrics (among others). In fact, his book, The Grammar of Science, was impactful on Einstein's early development.","correct":true},{"image":"danjou-pear.svg","alt":"Pierre the D'Anjou Pear","response":"Aside from his regular appearance in fruit cocktails, Pierre plays a title role in the famous pear & gorgonzola salad, among other tasty dishes. He also brags about the pear tree being the first and, in his words, the \"best of the gifts\" in the famous '12 Days of Christmas' song.","correct":false}]},{"question":"Co-founder of the journal 'Biometrika'","choices":[{"image":"karl-pearson.svg","alt":"Karl Pearson","response":"In addition to co-founding the journal, Pearson was the editor until his death in 1936. It was this editorial position and, in particular, his decision to reject a submission by Sir Ronald Fisher in the 1930s that lead to their life-long feud.","correct":true},{"image":"danjou-pear.svg","alt":"Pierre the D'Anjou Pear","response":"While he never was appointed to an editorial position, Pierre was a regular contributor to the magazine 'The Core,' which aims to educate the pear community about the management and treatment of seed irritation.","correct":false}]},{"question":"Inspired the 'Juicy Pear' flavor of Jelly Belly gourmet beans","choices":[{"image":"karl-pearson.svg","alt":"Karl Pearson","response":"Furthermore, Pierre's poetry and creative writing (written under the pen name 'Maya d'Anjou-loo') was the inspiration for the book 'All God's Children Need Traveling Shoes.'","correct":false},{"image":"danjou-pear.svg","alt":"Pierre the D'Anjou Pear","response":"Pearson's flavor was the inspiration for the immensely popular 'Human Flesh' flavor of Jelly Bellies.","correct":true}]},{"question":"Their son was a well-known statistician","choices":[{"image":"karl-pearson.svg","alt":"Karl Pearson","response":"Pearson’s son, Egon, made numerous contributions; in particular, he was instrumental to the development of hypothesis testing procedures, of Neyman-Pearson lemma fame.","correct":true},{"image":"danjou-pear.svg","alt":"Pierre the D'Anjou Pear","response":"Honest mistake—the 'Pearson' in the famous Neyman-Pearson lemma in mathematical statistics is often confused with 'Pear's son'. Unfortunately, Pierre was never able to have a son, as it turns out he was born from a family of experimental seedless pears.","correct":false}]},{"question":"Developed a number of still-widely-used statistical methods, including the chi-square test and method of moments","choices":[{"image":"karl-pearson.svg","alt":"Karl Pearson","response":"The chi-square test is named after Pearson and is taught to students in all areas of science. In fact, Pearson's chi-square test is likely the most widely-known statistical test, perhaps only outmatched by Student's t-test.","correct":true},{"image":"danjou-pear.svg","alt":"Pierre the D'Anjou Pear","response":"Pierre actually flunked the psychology statistics course he took during his junior year. However, he took the course again the following summer and successfully passed.","correct":false}]},{"question":"Their skin color cannot be used as an indicator of ripeness","choices":[{"image":"karl-pearson.svg","alt":"Karl Pearson","response":"Pearson's views on skin color, as it pertained to eugenics, would be considered deeply racist today, advocating war on \"inferior races.\"","correct":false},{"image":"danjou-pear.svg","alt":"Pierre the D'Anjou Pear","response":"Unlike Pierre's sworn enemy, the Bartlett pear (whose skin changes from green to yellow upon ripening), he retains his hearty green (or sometimes red) coloration. Pierre is ripe when the flesh around his neck is soft.","correct":true}]},{"question":"Was offered knighthood but refused","choices":[{"image":"karl-pearson.svg","alt":"Karl Pearson","response":"Pearson was a committed socialist and atheist, so his views strongly opposed those of Great Britain and the Christian church.","correct":true},{"image":"danjou-pear.svg","alt":"Pierre the D'Anjou Pear","response":"Having originated in Belgium or France, Pierre cannot be considered for knighthood by Great Britain. However, if offered knighthood, then he too would refuse, as the armor suit would surely puncture his juicy flesh.","correct":false}]}]}

/***/ }),
/* 348 */
/***/ (function(module, exports) {

module.exports = {"name":"Florence Nightingale or Common Nightingale","publishdate":"2018-11-01T00:00:00.000Z","icons":[{"src":"florence-nightingale.svg","alt":"Florence Nightingale"},{"src":"common-nightingale.svg","alt":"Common Nightingale"}],"questions":[{"question":"Known as the founder of modern nursing","choices":[{"image":"florence-nightingale.svg","alt":"Florence Nightingale","response":"With the establishment of her nursing school at St. Thomas' Hospital in London, Florence Nightingale laid the foundation for professional nursing. In addition, she implemented handwashing practices in war hospitals and kept the number of deaths as data.","correct":true},{"image":"common-nightingale.svg","alt":"Common Nightingale","response":"The common nightingale permanently abandoned nursing after it realized it was too small for the uniform.","correct":false}]},{"question":"Developed the polar area diagram","choices":[{"image":"florence-nightingale.svg","alt":"Florence Nightingale","response":"Florence Nightingale was a pioneer in infographics. She created the polar area diagram (a variation of the pie chart equivalent to a modern circular histogram) to illustrate seasonal sources of patient mortality in the military field hospital she managed.","correct":true},{"image":"common-nightingale.svg","alt":"Common Nightingale","response":"Contrary to popular belief, the common nightingale is one of the Founding Fathers of Satanism.","correct":false}]},{"question":"Became an icon of Victorian culture as \"The Lady with the Lamp\"","choices":[{"image":"florence-nightingale.svg","alt":"Florence Nightingale","response":"This nickname for Florence Nightingale was derived during the Crimean War from a report in 'The Times' regarding her habit of making rounds to wounded soldiers at night.","correct":true},{"image":"common-nightingale.svg","alt":"Common Nightingale","response":"While no lady with an appliance, the common nightingale’s nicknames include ‘sing-song-chicken’ and ‘chirp-chirp-death’.","correct":false}]},{"question":"Elected as the first female member of the Royal Statistical Society in 1859","choices":[{"image":"florence-nightingale.svg","alt":"Florence Nightingale","response":"In addition, Florence Nightingale became an honorary member of the American Statistical Association in 1874.","correct":true},{"image":"common-nightingale.svg","alt":"Common Nightingale","response":"The common nightingale does not believe in gender binaries.","correct":false}]},{"question":"Made a comprehensive statistical study of sanitation in Indian rural life","choices":[{"image":"florence-nightingale.svg","alt":"Florence Nightingale","response":"Florence Nightingale was a prominent figure in the introduction of improved medical care and public health service in India, contributing 40 years of work to her cause.","correct":true},{"image":"common-nightingale.svg","alt":"Common Nightingale","response":"The common nightingale published a study on bugs, bugs, more bugs...and singing.","correct":false}]},{"question":"Survives primarily by preying on invertebrates","choices":[{"image":"florence-nightingale.svg","alt":"Florence Nightingale","response":"While Florence Nightingale did offer nutritional advice based on comfort, rather than science, her dental records indicate she was not comfortable surviving off of invertebrates.","correct":false},{"image":"common-nightingale.svg","alt":"Common Nightingale","response":"The Common Nightingale enjoys a lively diet of beetles, ants, caterpillars, flies, spiders, earthworms, and the occasional seeds or berries during the Autumn season.","correct":true}]},{"question":"Referenced in literature to symbolize melancholy/joy, love/loss, and life/death","choices":[{"image":"florence-nightingale.svg","alt":"Florence Nightingale","response":"Florence Nightingale is not referenced for her love, but we love her all the same.","correct":false},{"image":"common-nightingale.svg","alt":"Common Nightingale","response":"Most impressively, the Common Nightingale (or its songs) makes an appearance in The Homer's 'Odyssey,' T.S. Eliot's 'The Wasteland,' and even in Shakespeare's 'Romeo and Juliet'.","correct":true}]},{"question":"Best known for their powerful and beautiful songs, made up of a wide range of whistles, trills, and gurgles","choices":[{"image":"florence-nightingale.svg","alt":"Florence Nightingale","response":"While Florence Nightingale was not known for her songs, there is audio of her voice dating all the way back to 1890. Whether her voice is beautiful or not is left as an exercise for the reader.","correct":false},{"image":"common-nightingale.svg","alt":"Common Nightingale","response":"The Common Nightingale frequently sings at night (in addition to the daytime). The most distinct feature of their song is a loud whistling crescendo.","correct":true}]}]}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_quiz_vue__ = __webpack_require__(353);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_260d16e5_hasScoped_false_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_quiz_vue__ = __webpack_require__(354);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_quiz_question_vue__ = __webpack_require__(358);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_quiz_result_vue__ = __webpack_require__(363);
...
var _currentQuiz = __webpack_require__(366);

var _currentQuiz2 = _interopRequireDefault(_currentQuiz);

var _quizzes = __webpack_require__(368);
...
var _roundTo = __webpack_require__(367);
...
/***/ })
/******/ ]);
//# sourceMappingURL=alternative-stats.5b4a4d84d933d7ff4bac.js.map